...
[mpv](https://mpv.io) 是一个轻量、以键盘操作为主的播放器，支持脚本扩展。
[mpvacious](https://github.com/Ajatt-Tools/mpvacious) 是运行在 mpv 内的 Lua 脚本，用于在播放视频时把当前句子的文本、音频和截图发送到 Anki。

## mpv

### 适用于Windows系统的整合包

[mpv整合包](https://github.com/benkyou-vip/docs/releases/latest) 使用github action自动打包shinchiro和mpvacious，预设配置，无需修改。
